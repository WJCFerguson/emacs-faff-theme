...
(custom-theme-set-faces
 ...
 '(org-agenda-date ((t (:inherit org-agenda-structure :background "cornsilk1" :box (:line-width (1 . 1) :color "grey75" :style pressed-button) :height 1.0))))
 ...
 '(org-agenda-structure ((t (:background "cornsilk1" :foreground "Blue3" :box (:line-width (1 . 1) :color "grey75" :style pressed-button)))))
 ...
 '(outline-2 ((t (:foreground "dark red" :weight bold :height 1.1))))
 '(outline-3 ((t (:foreground "purple4" :weight normal :height 1.0))))
