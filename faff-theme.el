...
(custom-theme-set-faces
 ...
 '(magit-branch-local ((t (:foreground "SkyBlue4" :box (:line-width 1 :color "grey75" :style released-button)))))
 ...
 '(magit-section-heading ((t (:background "ivory1" :foreground "DarkGoldenrod4" :box (:line-width 1 :color "grey75" :style released-button) :weight bold))))
