...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:background "gold" :foreground "black" :box (:line-width (1 . 1) :color "gold" :style flat-button) :overline t))))
 ...
 '(tab-bar-tab ((t (:inherit (variable-pitch tab-bar) :background "cornsilk3" :box (:line-width 1 :style pressed-button)))))
