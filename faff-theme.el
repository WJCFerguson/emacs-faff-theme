...
(custom-theme-set-faces
 ...
 '(org-date ((t (:box (:line-width (2 . 2) :color "grey75" :style released-button)))))
 '(org-verbatim ((t (:inherit shadow :extend t :background "cornsilk2"))))
 '(outline-1 ((t (:extend t :background "lightgoldenrod3" :weight bold :height 1.1))))
 '(outline-2 ((t (:foreground "red4" :weight bold :height 1.1))))
 '(outline-3 ((t (:foreground "purple4" :weight bold :height 1.05))))
 '(outline-4 ((t (:inherit font-lock-variable-name-face :height 1.05))))
