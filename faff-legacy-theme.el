;;; faff-legacy-theme.el --- Light Emacs color theme on cornsilk3 background (legacy)
...
;;; Commentary:
;;
;; NOTE: This was the former faff-theme before migrating to modus-themes.
;;
...
;;
;;   (load-theme 'faff-legacy t)
;;
;; Requirements: Emacs 24.

;;; Code:

(deftheme faff-legacy
  "Legacy faff theme.  Emacs default with cornsilk3 background and a few tweaks")
...
(provide-theme 'faff-legacy)
;;; faff-legacy-theme.el ends here
